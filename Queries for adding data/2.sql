...
'PROD1-1',    
'admin',    
NULL); INSERT INTO dbo.processed_containers (container_id, prefix, batch_activation_data_id) values ('AB000002'+ Cast(@counter as varchar),    'AEB122',    
(select max(batch_activation_data_id) from batch_activation_data) ); 
